...
class MessageFactory {
  static AISMessage create(
      String input, bool logging, bool legacy, bool isPayload) {
    String encoded = '';
    ...
    try {
      ...
      if (!legacy) {
        return switch (messageType) {
          ...
          19 => ExtendedClassBCSPositionReport.fromBinary(
              makeBinaryString(encoded)),
          27 =>
            LongRangeAISBroadcastMessage.fromBinary(makeBinaryString(encoded)),
